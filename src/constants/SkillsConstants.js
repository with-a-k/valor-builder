...
module.exports = {
  ...
  'bravado-fixed': {
    ...
    learn_sp: 6,
    season: 1,
    tags: ['Passive', 'Houserule', 'Positive'],
    level_speed: 'Fixed',
  ...
  'discreet-aura': {
    ...
    learn_sp: 6,
    season: 1,
    tags: ['Situational', 'Passive', 'Positive'],
    level_speed: 'Fixed',
  ...
  'energy-attacker': {
    ...
    learn_value: 6,
    season: 1,
    tags: ['Passive', 'EnergyAttack', 'Positive'],
    level_speed: 'Slow',
    level_sp: 3,
    level_value: 3,
    bonus: 'energyAttack',
  ...
  'improved-di': {
    ...
    learn_value: 2,
    season: 1,
    tags: ['Passive', 'DamageIncrement', 'Positive'],
    level_speed: 'Slow',
    level_sp: 3,
    level_value: 1,
  ...
  'physical-attacker': {
    ...
    learn_value: 6,
    season: 1,
    tags: ['Passive', 'PhysicalAttack', 'Positive'],
    level_speed: 'Slow',
    level_sp: 3,
    level_value: 3,
    bonus: 'physicalAttack',
  ...
  'regeneration': {
    ...
    learn_value: 10,
    season: 4,
    tags: ['Passive', 'HealthRegen', 'Positive'],
    level_speed: 'Slow',
    level_sp: 4,
    level_value: 10,
  ...
  'resistant': {
    ...
    learn_value: 4,
    season: 1,
    tags: ['Passive', 'Resistance', 'Positive'],
    level_speed: 'Slow',
    level_sp: 2,
    level_value: 2,
    bonus: 'resistance',
  ...
  'sprinter': {
    ...
    learn_value: 1,
    season: 1,
    tags: ['Passive', 'Movement', 'Positive'],
    level_speed: 'Slow',
    level_sp: 2,
    level_value: 1,
    bonus: 'movement',
  ...
  'stamina-recovery': {
    ...
    learn_value: 4,
    season: 4,
    tags: ['Passive', 'StaminaRegen', 'Positive'],
    level_speed: 'Slow',
    level_sp: 2,
    level_value: 4,
  ...
  'tireless': {
    ...
    learn_value: 8,
    season: 1,
    tags: ['Passive', 'MaxStamina', 'Positive'],
    level_speed: 'Fast',
    level_sp: 2,
    level_value: 6,
    bonus: 'maxStamina',
  ...
  'tough': {
    ...
    learn_value: 30,
    season: 1,
    tags: ['Passive', 'MaxHealth', 'Positive'],
    level_speed: 'Fast',
    level_sp: 2,
    level_value: 15,
    bonus: 'maxHealth',
  ...
  'unyielding-determination-raw': {
    ...
    learn_sp: 8,
    season: 4,
    tags: ['Passive', 'RAW', 'ValorPerRound', 'Positive'],
    level_speed: 'Fixed',
  ...
  'abundant-creation': {
    ...
    learn_sp: 5,
    season: 2,
    tags: ['Situational', 'Creation', 'Positive'],
    level_speed: 'Fixed',
  ...
  'bounce-back': {
    ...
    learn_sp: 6,
    season: 1,
    tags: ['Situational', 'ValorPerRound', 'Positive'],
    level_speed: 'Fixed',
  ...
  'clone-tactics': {
    ...
    learn_sp: 5,
    season: 2,
    tags: ['Situational', 'Clone', 'Positive'],
    level_speed: 'Fixed',
  ...
  'combat-toss': {
    ...
    learn_sp: 4,
    season: 2,
    tags: ['Situational', 'Toss', 'Positive'],
    level_speed: 'Fixed',
  ...
  'extended-range': {
    ...
    learn_sp: 6,
    season: 4,
    tags: ['Situational', 'Active', 'Positive'],
    level_speed: 'Fixed',
  ...
  'free-swift-step': {
    ...
    learn_sp: 5,
    season: 4,
    tags: ['Situational', 'Swift Step', 'Positive'],
    level_speed: 'Fixed',
  ...
  'improved-swimming': {
    ...
    learn_sp: 4,
    season: 1,
    tags: ['Situational', 'Challenge', 'Positive'],
    level_speed: 'Fixed',
  ...
  'protector': {
    ...
    learn_sp: 5,
    season: 1,
    tags: ['Situational', 'Cover', 'Repeatable', 'Positive'],
    level_speed: 'Fixed',
  ...
  'quick-to-act': {
    ...
    learn_value: 2,
    season: 1,
    tags: ['Situational', 'Passive', 'Initiative', 'Positive'],
    level_speed: 'Fixed',
    bonus: 'initiative',
  ...
  'revenge': {
    ...
    learn_sp: 5,
    season: 1,
    tags: ['Situational', 'Knockout', 'Positive'],
    level_speed: "Fixed",
  ...
  'attack-node-network': {
    ...
    learn_sp: 4,
    season: 3,
    tags: ['Active', 'Attack Node', 'Situational', 'Positive'],
    level_speed: 'Fixed',
  ...
  'dark-healing': {
    ...
    learn_sp: 6,
    season: 1,
    tags: ['Active', 'Malevolent Entity', 'Positive'],
    level_speed: 'Fixed',
  ...
  'seal': {
    ...
    learn_value: 1,
    season: 2,
    tags: ['Active', 'Repeatable', 'Positive'],
    level_speed: 'Slow',
    level_sp: 3,
    level_value: 1,
  ...
  'afterimage': {
    ...
    learn_sp: 4,
    season: 2,
    tags: ['Active', 'Swift Step', 'Positive'],
    level_speed: 'Fixed',
  ...
  'clash': {
    ...
    learn_sp: 3,
    season: 2,
    tags: ['Reaction', 'Counterattack', 'Positive'],
    level_speed: 'Fixed',
  ...
  'combination-attack-house': {
    ...
    learn_sp: 6,
    season: 1,
    tags: ['Reaction', 'Houserule', 'Positive'],
    level_speed: 'Fixed',
  ...
  'deflecting-shield': {
    ...
    learn_sp: 4,
    season: 3,
    tags: ['Reaction', 'Area Shield', 'Line Deflect', 'Positive'],
    level_speed: 'Fixed',
  ...
  'ranged-interrupt': {
    ...
    learn_sp: 4,
    season: 2,
    tags: ['Reaction', 'Interrupt Attack', 'Positive'],
    level_speed: 'Fixed',
  ...
  'asset': {
    ...
    learn_sp: 3,
    season: 1,
    tags: ['Challenge', 'Character', 'Repeatable', 'Positive'],
    level_speed: 'Fixed',
    description: ""
  },
  'challenge-technique': {
  ...
  'ally-mount': {
    ...
    learn_value: 1,
    season: 2,
    tags: ['Active', 'Companion', 'Mount', 'Positive'],
    level_speed: 'Slow',
    level_sp: 1,
    level_value: 1,
    description: ""
  ...
  'companion-sense': {
    ...
    learn_sp: 2,
    season: 3,
    tags: ['Active', 'Companion', 'Positive'],
    level_speed: 'Fixed',
    description: ""
  },
  'companion-zoc': {
    ...
    learn_value: 1,
    season: 2,
    tags: ['Passive', 'Companion', 'Positive'],
    level_speed: 'Slow',
    level_sp: 4,
    level_value: 1,
    description: ""
  ...
  'flank-attack': {
    ...
    learn_sp: 4,
    season: 2,
    tags: ['Situational', 'Companion', 'Positive'],
    level_speed: 'Fixed',
    description: ""
  },
  'flying-companion': {
  ...
  'protect-ally': {
    ...
    learn_sp: 2,
    season: 2,
    tags: ['Reaction', 'Companion', 'Protect Master', 'Positive'],
    level_speed: 'Fixed',
    description: ""
  },
  'protect-master': {
    ...
    learn_sp: 4,
    season: 2,
    tags: ['Reaction', 'Companion', 'Positive'],
    level_speed: 'Fixed',
    description: ""
  },
  'ranged-revival': {
  ...
  'tossing-companion': {
    ...
    learn_sp: 3,
    season: 2,
    tags: ['Active', 'Companion', 'Toss', 'Positive'],
    level_speed: 'Slow',
    level_sp: 1,
    level_value: 1,
    description: ""
